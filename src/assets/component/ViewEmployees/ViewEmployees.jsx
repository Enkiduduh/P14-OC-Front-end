...
function ViewEmployees() {
  ...
  function formatDateToDDMMYYYY(date) {
    ...
    const handleChange = (event) => {
      ...
      setEntriesDisplay(parseInt(value, 10));
      setCurrentPage(1);
    };
    ...
    const entriesPerPage = entriesDisplay; //
      ...
      <>
        ...
        <div className="viewEmployeePage-container">
          ...
          <table className="table-container">
            <thead className="thead-line-flex">{/* ... */}</thead>
          ...
          <div className="showEntryOnEntries-showPages">
            ...
            <div className="showPages">
              ...
              {Array.from(
                {
                  length: Math.ceil(filteredEmployees.length / entriesPerPage),
                },
                (_, i) => (
                  <button
                    key={i + 1}
